...
class TestRelativePosition(TestCase):
    ...
    def test_root_position_invalid_value(self):
        ...
        with self.assertRaises(ValueError) as context:
            RelativePosition.resolve(kwargs, path_field="path", path_factory=MockPathFactory())
...
class TestSortedPosition(TestCase):
    ...
    def test_root_position_invalid_value(self):
        ...
        with self.assertRaises(ValueError) as context:
            SortedPosition.resolve(kwargs, path_field="path", path_factory=MockPathFactory())
